-- FINAL: Complete plot ownership population with correct SQM values
-- This will populate ALL plots with the working approach from the debug script
...
-- 4. Now populate ALL plots with the working approach
...
-- 7. Show total summary across all plots
