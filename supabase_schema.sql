-- Comprehensive Supabase Schema for Subx Application
...
('2 Seasons - Plot 77', 'Premium residential plot in 2 Seasons Estate', '2 Seasons, Along Gbako/Kajola village road, Gbako Village, Via Kobape Obafemi-Owode Lga, Ogun state', 1000, 5000.00, ARRAY['Road access', 'Security', 'Drainage'], ARRAY['plot77-1.jpg', 'plot77-2.jpg']),
('Kobape Gardens - Phase 1', 'Affordable housing estate in Abeokuta', 'Kobape, Abeokuta, Ogun State', 500, 3000.00, ARRAY['Road access', 'Water supply', 'Electricity'], ARRAY['kobape-1.jpg', 'kobape-2.jpg']),
('Victoria Island Luxury Apartments', 'High-end residential apartments', 'Victoria Island, Lagos', 800, 8000.00, ARRAY['Swimming pool', 'Gym', 'Security', 'Parking'], ARRAY['vi-1.jpg', 'vi-2.jpg']);

-- Insert sample investments for existing users
...
('00000000-0000-0000-0000-000000000001', 'Welcome to Subx Community!', 'Welcome to our community! Feel free to discuss real estate investment strategies, ask questions, and connect with other investors.', 'general'),
('00000000-0000-0000-0000-000000000002', 'Investment Tips for Beginners', 'I''m new to real estate investment. Any tips for someone just starting out? What should I focus on first?', 'investment'),
('00000000-0000-0000-0000-000000000003', 'Best Locations for Investment in 2025', 'What are your thoughts on the best locations for real estate investment this year? I''m particularly interested in emerging markets.', 'investment');

-- Insert sample forum replies
INSERT INTO forum_replies (topic_id, user_id, content) VALUES
(1, '00000000-0000-0000-0000-000000000002', 'Welcome everyone! Great to be part of this community.'),
(1, '00000000-0000-0000-0000-000000000003', 'Thanks for the warm welcome! Looking forward to learning from everyone.'),
(2, '00000000-0000-0000-0000-000000000001', 'Start with smaller investments and gradually increase as you learn.'),
(3, '00000000-0000-0000-0000-000000000002', 'I think emerging markets in Ogun State show great potential.');
