  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 max-w-md w-full relative">
        ...
        <p className="mb-6 text-gray-700 dark:text-gray-200">Your payment was successful. You can now download your documents and sign your Deed of Assignment.</p>
        <div className="flex flex-col gap-4">
          ...
          <button onClick={onDownloadCertificate} className="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700">Download Certificate</button>
