-- =====================================================
-- COMPLETE SYSTEM SCHEMA FIX (FINAL & PERFECT)
-- =====================================================
...
-- STEP 2: MIGRATE EXISTING DATA (PERFECT - NO CONSTRAINT ISSUES)
-- =====================================================

-- Migrate existing users from user_profiles (PERFECT)
...
-- Migrate existing plot ownership to units_purchased_new (PERFECT)
...
-- Migrate existing investments to purchases_new (PERFECT)
...
-- STEP 3: VERIFY REFERRAL CODES ARE UNIQUE
-- =====================================================

-- Check for any duplicate referral codes (should be none)
SELECT 'Verifying referral codes are unique...' as status;
