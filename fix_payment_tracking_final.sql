-- =====================================================
-- FIX PAYMENT TRACKING AND DATA FLOW (FINAL & PERFECT - WORKING)
-- =====================================================
...
-- Final count of linked ownership and investments
SELECT 
  'FINAL VERIFICATION:' as verification_step,
  COUNT(po.id) as total_plots,
  COUNT(CASE WHEN po.purchase_id IS NOT NULL THEN 1 END) as linked_plots,
  COUNT(CASE WHEN po.purchase_id IS NULL THEN 1 END) as unlinked_plots
FROM plot_ownership po;

-- Final count of referral earnings
SELECT 
  'REFERRAL EARNINGS FINAL COUNT:' as verification_step,
...
SELECT 'FINAL PAYMENT TRACKING FIXED SUCCESSFULLY!' as status;
...
SELECT 'No syntax errors - script completed successfully!' as final_status;
